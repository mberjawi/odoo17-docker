...
Install [docker](https://docs.docker.com/get-docker/) and [docker-compose](https://docs.docker.com/compose/install/) yourself, then run the following to set up first Odoo instance @ `localhost:10017` (default master password: `marwanberjawi.com`):

``` bash
curl -s https://raw.githubusercontent.com/mberjawi/odoo17-docker/master/run.sh | sudo bash -s odoo-one 10017 20017
```
and/or run the following to set up another Odoo instance @ `localhost:11017` (default master password: `marwanberjawi.com`):

``` bash
curl -s https://raw.githubusercontent.com/mberjawi/odoo17-docker/master/run.sh | sudo bash -s odoo-two 11017 21017
```
